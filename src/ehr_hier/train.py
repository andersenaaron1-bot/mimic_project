    ...
    for step, batch in enumerate(pbar):
        ...
        with torch.amp.autocast('cuda'):
            ...
            head_outputs, _ = model(
                ...
                token_event_index=inputs.get('token_event_index', None),
                token_event_slot_ids=inputs.get('token_event_slot_ids', None),
                event_input_ids=inputs.get('event_input_ids', None),
                event_time_ids=inputs.get('event_time_ids', None),
                event_numeric_values=inputs.get('event_numeric_values', None),
                event_numeric_mask=inputs.get('event_numeric_mask', None),
                event_type_ids=inputs.get('event_type_ids', None),
                event_payload_ids=inputs.get('event_payload_ids', None),
                event_attention_mask=inputs.get('event_attention_mask', None),
                event_memory_rule_scores=inputs.get('event_memory_rule_scores', None),
                event_memory_group_ids=inputs.get('event_memory_group_ids', None),
                event_memory_first_flags=inputs.get('event_memory_first_flags', None),
                event_memory_chronic_flags=inputs.get('event_memory_chronic_flags', None),
